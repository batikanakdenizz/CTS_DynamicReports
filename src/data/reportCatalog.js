...
const RAW = [
  ...
  {
    key: 'designTargetSpeed',
    label: 'Design Target Speed',
    format: 'int',
    group: 'Time',
    agg: 'avg',
  },
  ...
  {
    key: 'unplannedStopDuration',
    label: 'Unplanned Stop Duration',
    format: 'min',
    group: 'Duration',
  },
...
const DERIVED = [
  ...
  {
    key: 'plannedDowntimeLoss',
    label: 'Planned Downtime Loss %',
    format: 'pct',
    group: 'KPI',
    color: '#6b7f99',
    num: (r) => r.plannedStopDuration * r.designTargetSpeed,
    den: (r) => r.theoVolume,
    scale: 100,
  },
  {
    key: 'unplannedDowntimeLoss',
    label: 'Unplanned Downtime Loss %',
    format: 'pct',
    group: 'KPI',
    color: '#d6455d',
    num: (r) => r.unplannedStopDuration * r.designTargetSpeed,
    den: (r) => r.theoVolume,
    scale: 100,
  },
  {
  ...
  },
  {
    ...
    group: 'KPI',
    color: '#2aa9bf',
    num: (r) => r.totalRuntime,
    den: (r) => r.scheduledTime,
    scale: 100,
  },
  {
    key: 'totalLoss',
